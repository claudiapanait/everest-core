...
@pytest.mark.asyncio
async def test_basic_charging(everest_core: EverestCore):
    """
    Launch EVerest with 'probe' as standalone module and perform a BASIC IEC test.
    """
    logging.info(">>>>>>>>>> BASIC CHARGING TEST START <<<<<<<<<<")
    ...
    logging.info("Starting EVerest with PROBE module…")
    everest_core.start(standalone_module='probe', test_connections=test_connections)

    # Create runtime session for module access
    ...
    logging.info(">>>>>>>>>> BASIC CHARGING TEST PASSED <<<<<<<<<<")


# --------------------------------------------------------------------------
# HLC ISO15118‑2 AC TEST
# --------------------------------------------------------------------------
@pytest.mark.everest_core_config('config-sil.yaml')
@pytest.mark.asyncio
...
# --------------------------------------------------------------------------
# HLC ISO15118‑2 DC TEST
# --------------------------------------------------------------------------
@pytest.mark.everest_core_config('config-sil-dc.yaml')
@pytest.mark.asyncio
async def test_hlc_dc_charging(everest_core: EverestCore):
    """
    Launch EVerest with 'probe' and perform an ISO15118‑2 DC (HLC) charging test.
    """
    logging.info(">>>>>>>>>> HLC ISO15118-2 DC TEST START <<<<<<<<<<")
    ...
    logging.info("Starting EVerest with PROBE module (HLC DC)…")
    everest_core.start(standalone_module='probe', test_connections=test_connections)
    ...
    assert probe.test(90, Mode.HLC_DC)

    logging.info(">>>>>>>>>> HLC ISO15118-2 DC TEST PASSED <<<<<<<<<<")
